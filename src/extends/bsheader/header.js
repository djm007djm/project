								...
								<div class="allGoods">
									...
									<div class="navTwo">
										<div class="item">
											<h3>
												<span></span>
												<a href="html/list.html" class="a">水果蔬菜</a>
											</h3>
											<!-- 三级导航 -->
											<div class="navThree">
												<dl class="kind">
										...
										<div class="item">
											<h3>
												...
												<a href="html/list.html" class="b">肉禽蛋奶</a>
											</h3>
											<!-- 三级导航 -->
											<div class="navThree">
												<dl class="kind">
										...
										<div class="item">
											<h3>
												...
												<a href="html/list.html" class="c">粮油副食</a>
											</h3>
											<!-- 三级导航 -->
											<div class="navThree">
												<dl class="kind">
										...
										<div class="item">
											<h3>
												...
												<a href="html/list.html" class="d">零食酒饮</a>
											</h3>
											<!-- 三级导航 -->
											<div class="navThree">
												<dl class="kind">
										...
										<div class="item">
											<h3>
												...
												<a href="html/list.html" class="e">主题场景</a>
											</h3>
											<!-- 三级导航 -->
											<div class="navThree">
												<dl class="kind">
										...
										<div class="item">
											<h3>
												...
												<a href="html/list.html" class="f">这箱有利</a>
											</h3>
											<!-- 三级导航 -->
											<div class="navThree">
												<dl class="kind">
										...
										<div class="item">
											<h3>
												...
												<a href="html/list.html" class="g">生活用品</a>
											</h3>
											<!-- 三级导航 -->
											<div class="navThree">
												<dl class="kind">
